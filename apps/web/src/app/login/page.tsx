      ...
      <div className="hidden lg:flex lg:w-[55%] xl:w-[60%] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20 py-12 max-w-3xl">
          ...
          <div className="flex items-center gap-3 mb-10">
            <div className="w-12 h-12 rounded-2xl overflow-hidden shadow-lg shadow-primary/20 ring-1 ring-border/50 bg-[#160324] flex items-center justify-center shrink-0 p-1.5">
              <img src="/logo.svg" alt="OpenSandbox" className="w-full h-full object-contain" />
            </div>
            <h1 className="text-3xl font-bold text-foreground tracking-tight">OpenSandbox</h1>
          </div>
          ...
          <div className="mt-8 relative rounded-2xl overflow-hidden border border-border/80 shadow-2xl shadow-primary/10 group">
            ...
            <img
              src="/hero.png"
              alt="OpenSandbox Visual Flow Architecture"
              className="w-full h-auto max-h-[260px] object-cover group-hover:scale-105 transition-transform duration-700"
            />
            <div className="absolute bottom-3 left-3 right-3 z-20 flex items-center justify-between text-xs text-muted-foreground backdrop-blur-md bg-background/70 px-3 py-1.5 rounded-lg border border-border/60">
              <span className="font-mono text-primary font-semibold">Visual Engine v1.0</span>
              <span>Drag, connect & deploy in seconds</span>
            </div>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 relative">
        ...
        <div className="relative w-full max-w-sm">
          ...
          <div className="flex lg:hidden items-center justify-center gap-3 mb-8">
            <div className="w-10 h-10 rounded-2xl overflow-hidden shadow-lg shadow-primary/20 ring-1 ring-border/50 bg-[#160324] flex items-center justify-center shrink-0 p-1">
              <img src="/logo.svg" alt="OpenSandbox" className="w-full h-full object-contain" />
            </div>
            <h1 className="text-2xl font-bold text-foreground tracking-tight">OpenSandbox</h1>
          </div>
            ...
            {IS_DEV ? (
              <form onSubmit={handleLocalSubmit} className="space-y-4">
                {mode === 'register' && (
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-3 py-2.5 border border-border rounded-xl text-sm bg-background focus:ring-2 focus:ring-primary/40 focus:border-primary/70 outline-none transition-all"
                    />
                  </div>
                )}
                <div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 px-4 rounded-xl bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 active:scale-[0.98] transition-all shadow-sm disabled:opacity-60"
                >
                  {loading ? (
                ...
                <div className="pt-3 border-t border-border">
                  <p className="text-[10px] text-center text-muted-foreground/60 uppercase tracking-wider mb-2">Dev mode</p>
                  <button
                    type="button"
                    onClick={handleGoogleRedirect}
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-white text-zinc-900 text-xs font-medium hover:bg-zinc-100 active:scale-[0.98] transition-all shadow-sm border border-border disabled:opacity-60"
                  >
