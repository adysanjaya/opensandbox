...
import { ArrowDownTrayIcon, ArrowLeftIcon, PlayIcon, GlobeAltIcon, ArrowPathIcon, LinkIcon, CheckIcon } from '@heroicons/react/24/outline';
          ...
          <div className="flex items-center gap-2">
            ...
            {slug && !isNew && (
              <button
                ...
                className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-mono text-muted-foreground bg-muted/60 hover:bg-primary/10 hover:text-primary transition-all border border-border"
                title="Salin Public URL Endpoint"
              >
                {copiedUrl ? (
                  <>
